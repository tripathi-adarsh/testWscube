...
<div class="row px-5">                 
    <div class="col-12 ">
        <div class="cust-container-desc-title float-left" style="margin-bottom: 0px;">
            <h3 class="cust-container-desc-title-h3 cus-school-teachers-head custom_teachers_count cus-font-family-lato ">
                <span  class="cus-admin-logo">Edit Subject</span>
            </h3>
        </div>                  
    </div>
    ...
    <div class="col-12 p-3">
        <!-- BEGIN OF FORM-->
        <form action="{{'/update-subject/'.$subject->id}}" class="form-horizontal text-margin-top" method="POST" accept-charset="UTF-8">            
            @csrf
            <div class="form-body row">
                ...
                <label class="col-12 control-label cus-color-brown"><b>Name</b></label>
                    ...
                    @enderror
                        <input type="text" name="name"  class="form-control input-circle cust-grey-border-col" style="background:transparent; "   placeholder="Name" value="{{$subject['name']}}" required>
                    </div>
                </div>
                ...
                <label class="col-12 control-label cus-color-brown"><b> Description</b></label>
                    ...
                    @enderror
                        ...
                        <textarea class="form-control input-circle cust-grey-border-col " style="height:150px; background:transparent; outline-color: black;  color: black;"   name="description" placeholder=" Description" value="{{$subject['description']}}" >{{$subject['description']}}</textarea >
                    </div>
                </div>
                ...
                <div class="text-center col-12 p-3">
                    ...
                    <a class="btn btn-circle grey-salsa btn-outline btn-danger" href="{{'/subjects'}}">Cancel </a>
                </div>                              
            </div>
        </form>
        <!-- END OF FORM-->
