    ...
    <div class="container-fluid " >
        ...
        <div class="row m-0 mt-3 custom_row_mr">
            <div class="col-xs-12 col-sm-6 col-md-4">
                <a href="/subjects" >
                <div class="card p-3 py-5 " title="New request for book approval, Click here to view."  style="background-color:#007C89; border-radius:23px;">
                    <span class="text-white m-0 text-center font-weight-bold cust_das_tile"><b>Subjects</b></span>
                </div>
                </a>
            </div>
